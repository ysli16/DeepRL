...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        return self.obs[permuted_indices[-batch_size:]], self.acs[permuted_indices[-batch_size:]], self.rews[
            permuted_indices[-batch_size:]], self.next_obs[permuted_indices[-batch_size:]], self.terminals[
                   permuted_indices[-batch_size:]]
